...
void loadTaskOnJFile(const ToDoList &todo);  //Carica le attività da una lista di attività e le memorizza in una un file JSON

void loadTaskFromFile(ToDoList &todo);  //Carica le attività da un file JSON e le memorizza in una lista di attività
